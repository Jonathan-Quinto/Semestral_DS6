...
public final class ActivityCategoriasBinding implements ViewBinding {
  ...
  private ActivityCategoriasBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView rvCategorias) {
  ...
  public static ActivityCategoriasBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCategoriasBinding((LinearLayout) rootView, rvCategorias);
    }
